...
def classify_image(image_path):
    try:
        ...
        pgd = ProjectedGradientDescent(estimator=art_classifier, eps=0.05, eps_step=0.01, max_iter=10)
        adv_inputs = pgd.generate(x=pixel_values_np)
        
        # Apply additional perturbation limiting
        adv_inputs = limit_perturbation(pixel_values_np, adv_inputs, max_diff=0.05)
